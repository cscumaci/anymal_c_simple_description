...
double delta_x_wp2_R = 0.085; 
  ...
  double delta_x = 0.078;// - delta_x_avanti; 
  double delta_xx = 0.078; // - delta_x_avanti; 
  ...
  while (ros::ok())
    {
      ...
      base_state.velocity[0] = 0.0;
      base_state.effort[0] = 0.0;
      
      base_state.name[1] = " y ";
      base_state.position[1] = y_time;
      base_state.velocity[1] = 0.0;
      base_state.effort[1] = 0.0;
      
      base_state.name[2] = " z ";
      base_state.position[2] = z_time;
      base_state.velocity[2] = 0.0;
      base_state.effort[2] = 0.0;
    
      
      base_state.name[3] = " roll ";
      base_state.position[3] = roll_time;
      base_state.velocity[3] = 0.0;
      base_state.effort[3] = 0.0;
      
      base_state.name[4] = " pitch ";
      base_state.position[4] = pitch_time;
      base_state.velocity[4] = 0.0;
      base_state.effort[4] = 0.0;
      
      base_state.name[5] = " yaw ";
      base_state.position[5] = yaw_time;
      base_state.velocity[5] = 0.0;
      base_state.effort[5] = 0.0;
