...
{ 
    ...
    this-> delta_x_avanti_pub = n.advertise<std_msgs::Float64>("/anymal/floating_base_controller/delta_x_avanti_pub", 1000);
    ...
    this-> conta_friction_pub = n.advertise<std_msgs::Float64>("/anymal/floating_base_controller/conta_friction_pub", 1000);
    ...
    this-> conta_friction_sub = n.subscribe<std_msgs::Float64>("conta_friction_set_command", 1000, &floating_base_controller::conta_friction_setCommand, this);
    this-> delta_x_avanti_sub = n.subscribe<std_msgs::Float64>("delta_x_avanti_set_command", 1000, &floating_base_controller::delta_x_avanti_setCommand, this);
    ...
    ni_int_des(0) = 0.0;//0.05;
    ni_int_des(1) = 0.0;//-0.09; 
    ni_int_des(2) = 0.545;
    ni_int_des(3) = 0.0;
    ni_int_des(4) = 0.0;//-0.015;
    ni_int_des(5) = 0.0; 
    ...
    {   
      ...
      //Transformation from a quaternion parametrization to Euler angles(R,P,Y) of the unactuated joints
       ...
       //Update of current base positions 
        ...
        //Update of current joints positions and velocities and accelerations
        for (size_t i = 0; i<12; i++)
        {
            q_curr(i+6) = joint_handle[i].getPosition();
            dot_q_curr(i+6) = joint_handle[i].getVelocity();
       ...
       /* if(t > 2.5 )
        ...
        if(c_switch == 0)
        {
            ...
            Fc_trans = Eigen::MatrixXd::Zero(6, 1);
           ...
           /* cout<<"pos_foot_LF_media"<<endl<<pos_foot_LF_media<<endl;
            ...
            this->delta_x_avanti_pub.publish(delta_x_avanti_msg);
            ...
            cout<<"q_curr(0)"<<endl<<q_curr(0)<<endl;
            /*if(q_curr(0) > 0.6)
            { 
                delta_x_avanti = q_curr(0)-0.6;
            }*/
...
/*
           ...
           // Contact force
            ...
            //Fc_trans = S_ker_trans * Jc_trans * Fc;
            cout<<"Fc_trans"<<endl<<Fc_trans<<endl;
...
*/
            ...
            Fc_LF_Tx = sqrt(pow(Fc(0,0),2));
            Fc_LF_Ty = sqrt(pow(Fc(1,0),2));
            Fc_LH_Tx = sqrt(pow(Fc(3,0),2));
            Fc_LH_Ty = sqrt(pow(Fc(4,0),2));
            
            Fc_RF_Tx = sqrt(pow(Fc(6,0),2));
            Fc_RF_Ty = sqrt(pow(Fc(7,0),2));
            Fc_RH_Tx = sqrt(pow(Fc(9,0),2));
            Fc_RH_Ty = sqrt(pow(Fc(10,0),2));

            Fc_LF_T = sqrt(pow(Fc(0,0),2) + pow(Fc(1,0),2));
            Fc_LH_T = sqrt(pow(Fc(3,0),2) + pow(Fc(4,0),2));
            Fc_RF_T = sqrt(pow(Fc(6,0),2) + pow(Fc(7,0),2));
            Fc_RH_T = sqrt(pow(Fc(9,0),2) + pow(Fc(10,0),2));


            //Fc_LF3 = sqrt(pow(Fc(2,0),2));
            //Fc_LH3 = sqrt(pow(Fc(5,0),2));
            //Fc_RF3 = sqrt(pow(Fc(8,0),2));
            //Fc_RH3 = sqrt(pow(Fc(11,0),2));
           ...
           /* cout<<"Fc_LF3"<<endl<<Fc_LF3<<endl;
            cout<<"Fc_LH3"<<endl<<Fc_LH3<<endl;
            cout<<"Fc_RF3"<<endl<<Fc_RF3<<endl;
            cout<<"Fc_RH3"<<endl<<Fc_RH3<<endl;*/

            Fc_LFx_prova = mu*Fc_LF3;
            Fc_LFy_prova = mu*Fc_LF3;
            Fc_LHx_prova = mu*Fc_LH3;
            Fc_LHy_prova = mu*Fc_LH3;
            Fc_RFx_prova = mu*Fc_RF3;
            Fc_RFy_prova = mu*Fc_RF3;
            Fc_RHx_prova = mu*Fc_RH3;
            Fc_RHy_prova = mu*Fc_RH3;

               /*cout<<"Fc_LF_T"<<endl<<Fc_LF_T<<endl<<"Fc_LF_prova"<<endl<<Fc_LFx_prova<<endl<<Fc_LFy_prova<<endl;
                cout<<"Fc_LH_T"<<endl<<Fc_LH_T<<endl<<"Fc_LH_prova"<<endl<<Fc_LHx_prova<<endl<<Fc_LHy_prova<<endl;
                cout<<"Fc_RF_T"<<endl<<Fc_RF_T<<endl<<"Fc_RF_prova"<<endl<<Fc_RFx_prova<<endl<<Fc_RFy_prova<<endl;
                cout<<"Fc_RH_T"<<endl<<Fc_LF_T<<endl<<"Fc_RH_prova"<<endl<<Fc_RHx_prova<<endl<<Fc_RHy_prova<<endl;*/

               

            if((Fc_LF_T > Fc_LFx_prova || Fc_LH_T > Fc_LHx_prova || Fc_RF_T > Fc_RFx_prova || Fc_RH_T > Fc_RHx_prova || Fc_LF_T > Fc_LFy_prova || Fc_LH_T > Fc_LHy_prova || Fc_RF_T > Fc_RFy_prova || Fc_RH_T > Fc_RHy_prova) && t > 2)
            {

               /* cout<<"Fc_LF_T"<<endl<<Fc_LF_Tx<<endl<<Fc_LF_Ty<<endl<<"Fc_LF_prova"<<endl<<Fc_LFx_prova<<endl<<Fc_LFy_prova<<endl;
                cout<<"Fc_LH_T"<<endl<<Fc_LH_Tx<<endl<<Fc_LF_Ty<<endl<<"Fc_LH_prova"<<endl<<Fc_LHx_prova<<endl<<Fc_LHy_prova<<endl;
                cout<<"Fc_RF_T"<<endl<<Fc_RF_Tx<<endl<<Fc_RF_Ty<<endl<<"Fc_RF_prova"<<endl<<Fc_RFx_prova<<endl<<Fc_RFy_prova<<endl;
                cout<<"Fc_RH_T"<<endl<<Fc_LF_Tx<<endl<<Fc_LF_Ty<<endl<<"Fc_RH_prova"<<endl<<Fc_RHx_prova<<endl<<Fc_RHy_prova<<endl;
                cout<<"nooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo"<<endl;*/
            ...
            if(pos_foot_RH(1) < -0.34 && t > 10)
             {
               ...
               lungh_L = sqrt(pow(pos_foot_LF(0),2) + pow(pos_foot_LH(0),2));
           lungh_R = sqrt(pow(pos_foot_RF(0),2) + pow(pos_foot_RH(0),2));

           cout<<"lungh_L"<<endl<<lungh_L<<endl;
            cout<<"lungh_R"<<endl<<lungh_R<<endl;
            ...
            pos_LF_media = sqrt(pow(pos_foot_LF(0),2));
            //cout<<"pos_LF_media"<<endl<<pos_LF_media<<endl;
          ...
          if((pos_foot_LH(1) > 0.32 || pos_foot_LH(1) < 0.2) && t > 10) {
           ...
           if((pos_foot_RH(1) > -0.39 && pos_foot_RH(1) < -0.38 || pos_foot_RH(1) < -0.13 && pos_foot_RH(1) > -0.15) && t > 10) {
            ...
            //if((pos_foot_RH(1) > -0.39 && pos_foot_RH(1) < -0.38 || pos_foot_LH(1) < 0.37 && pos_foot_LH(1) > 0.36) && t > 10) {
             ...
             if(t > 50 && f == 1 && endd == 0 && (conta_friction == 0  || conta_friction == 1))
             {
                   cout<<"pos_foot_LH(1)"<<endl<<pos_foot_LH(1)<<endl;
                   cout<<"pos_foot_RH(1)"<<endl<<pos_foot_RH(1)<<endl;
                //friction_cone = 0;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        this->conta_friction_pub.publish(conta_friction_msg);
        ...
        force_L.linear.x = Fc_LF_T; //Ft_LFx;
        force_L.linear.y = Fc_LFx_prova; //Ft_LFy;
       ...
       /* force_L.linear.x = Fc_LF;
        ...
        //RF and RH
        force_R.linear.x = pos_LF_media;
        force_R.linear.y = pos_foot_LF(0);
    ...
    void floating_base_controller::fine_setCommand(const std_msgs::BoolConstPtr& msg)
    {
        ...
        void floating_base_controller::conta_friction_setCommand(const std_msgs::Float64ConstPtr& msg)
    {
        conta_friction = msg->data;
    }

        void floating_base_controller::delta_x_avanti_setCommand(const std_msgs::Float64ConstPtr& msg)
    {
